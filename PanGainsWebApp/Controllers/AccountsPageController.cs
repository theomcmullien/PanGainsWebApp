...
{
    public class AccountsPageController : Controller
    {
        private readonly PanGainsWebAppContext _context;
        private readonly ILogger<AccountsPageController> _logger;

        public AccountsPageController(PanGainsWebAppContext context, ILogger<AccountsPageController> logger)
        {
            _context = context;
            _logger = logger;
        }
